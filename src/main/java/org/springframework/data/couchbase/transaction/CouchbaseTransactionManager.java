...
public class CouchbaseTransactionManager extends AbstractPlatformTransactionManager
	...
	protected Object doGetTransaction() throws TransactionException {
		...
		CouchbaseResourceHolder resourceHolder = (CouchbaseResourceHolder) TransactionSynchronizationManager
				.getResource(getRequiredDbFactory().getCluster());
...
// 	should ACR already be in TSM?	TransactionSynchronizationManager.bindResource(getRequiredDbFactory().getCluster(), resourceHolder);
		...
		System.err.println("TransactionManager: "+this);
		System.err.println("bindResource: "+getRequiredDbFactory().getCluster());
		TransactionSynchronizationManager.bindResource(getRequiredDbFactory().getCluster(), resourceHolder);
	}
	...
	protected Object doSuspend(Object transaction) throws TransactionException {
		...
		return TransactionSynchronizationManager.unbindResource(getRequiredDbFactory().getCluster());
	}
	...
	protected void doResume(@Nullable Object transaction, Object suspendedResources) {
		TransactionSynchronizationManager.bindResource(getRequiredDbFactory().getCluster(), suspendedResources);
	}
	...
	protected void doCleanupAfterCompletion(Object transaction) {
		...
		TransactionSynchronizationManager.unbindResource(getRequiredDbFactory().getCluster());
	 ...
	 */
	private CouchbaseClientFactory getRequiredDbFactory() {
